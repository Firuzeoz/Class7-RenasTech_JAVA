...
public class Topic4_Example {
 ...
 /*
        ...
        for (int i = 0; i < words.length; i++) {
            ...
            int countA = 0; // for each word i need to reset my words
            int countL = 0; // for each word i need to reset my words
            int countB = 0; // for each word i need to reset my words
            //that's why putting counts in here is important
