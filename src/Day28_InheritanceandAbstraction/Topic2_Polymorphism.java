...
public class Topic2_Polymorphism {
    ...
    ArrayList<Animal> MyZoo=new ArrayList<>();
        ...
        for (int i = 0; i <MyZoo.size() ; i++) { //arraylist inin sizeini yaz mutlaka
            Animal AnAnimal= MyZoo.get(i);
            AnAnimal.AnimalSound();
            //     Below code is the same with the code above
...
/// Class int extends Object-->FALSE! Because we are creating them in later
///Class Integer extends from Object
